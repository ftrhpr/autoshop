                    ...
                    <div class="overflow-x-auto bg-white rounded-lg shadow-lg border border-gray-200">
                        <table class="w-full text-xs sm:text-sm min-w-full">
                            <thead class="bg-gradient-to-r from-gray-100 to-gray-200">
                                <tr>
                                    <th class="px-1 py-3 sm:px-2 sm:py-4 text-left font-semibold text-gray-700">Plate</th>
                                    <th class="px-1 py-3 sm:px-2 sm:py-4 text-left font-semibold text-gray-700">Name</th>
                                    <th class="px-1 py-3 sm:px-2 sm:py-4 text-left font-semibold text-gray-700">Phone</th>
                                    <th class="px-1 py-3 sm:px-2 sm:py-4 font-semibold text-gray-700">Actions</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr class="border-t border-gray-200 hover:bg-blue-50 transition">
                                    ...
                                    <td class="px-1 py-3 sm:px-2 sm:py-4 space-x-2">
                                        <button onclick="prefill(<?php echo $c['id']; ?>)" class="inline-flex items-center px-2 py-1 sm:px-3 sm:py-2 bg-blue-100 hover:bg-blue-200 text-blue-800 rounded-md text-xs font-medium transition">
                                        ...
                                        <form method="post" style="display:inline-block" onsubmit="return confirm('Delete?');">
                                            ...
                                            <button type="submit" name="delete_customer" class="inline-flex items-center px-2 py-1 sm:px-3 sm:py-2 bg-red-100 hover:bg-red-200 text-red-800 rounded-md text-xs font-medium transition">
                                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
