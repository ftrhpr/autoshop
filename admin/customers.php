            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <form method="post" action="import_customers_raw.php" class="bg-white p-4 rounded border mt-4">
                        ...
                        <p class="text-xs text-gray-500 mb-2">Paste names and phones separately (one per line). Import will pair them by line and insert new customers or update existing ones by phone.</p>
                        <div class="grid grid-cols-2 gap-4 mb-2">
                            <div>
                                <label class="block text-sm font-medium mb-1">Names (one per line)</label>
                                <textarea name="names" rows="6" placeholder="John Doe&#10;Jane Smith" class="w-full px-2 py-2 border rounded"></textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium mb-1">Phones (one per line)</label>
                                <textarea name="phones" rows="6" placeholder="+995555000000&#10;+995555111111" class="w-full px-2 py-2 border rounded"></textarea>
                            </div>
                        </div>
