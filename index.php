                        ...
                        <div class="bg-white p-4 md:p-6 rounded-lg shadow-sm border-t-4 border-yellow-500">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="input_service_manager" placeholder="Manager Name" value="Test User" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500 p-3 border text-base">
